...
const SideBar = ({ selectedSection }) => {
	...
	return (
		<div>
			<Filter />
			<div className="w-44 sm:w-52 bg-gray-700 fixed top-0 left-0 bottom-0 p-2 transofrm z-20">
				...
				<p
					className="absolute bottom-0 w-11/12 hover:bg-gray-400 px-1 py-3 rounded-md cursor-pointer text-white"
					onClick={() => {
						dispatch(logout());
